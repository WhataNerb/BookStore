...
<script type="text/javascript">
    $(function(){
        ...
        $(":text").change(function(){
            ...
            //2. 请求地址为: updateItemQuantity.do
            var url = "updateItemQuantity.do";
    ...
    <table cellpadding="10">
        ...
        <c:forEach items="${sessionScope.ShoppingCart.items}" var="item">
            <tr>
                ...
                <td><a href="remove.do?pageNo=${param.pageNo}&id=${item.book.id}" class="delete">删除</a></td>
            </tr>
        </c:forEach>
        ...
        <tr>
            <td colspan="4">
                ...
                <a href="clear.do">清空购物车</a>
                &nbsp;&nbsp;

                <a href="forwardPage.do?page=cash">结账</a>
                &nbsp;&nbsp;
            </td>
        </tr>
